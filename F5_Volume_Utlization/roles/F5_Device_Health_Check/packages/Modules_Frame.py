...
# from Working_Scripts.Scripts.Python.Python_Net_Connect.Linux_test.Final_linux_F5_test.Device_Types import platforms, platforms_str, CLASS_MAPPER, BaseConnection, TerminalServer, CLASS_MAPPER_BASE
from os import path
...
# from builtins import object    # pylint: disable=redefined-builtin
# from __builtin__ import unicode, str
unicode = str
